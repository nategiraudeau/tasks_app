...
class _OverviewState extends State<Overview>
  ...
  ListTile buildPercentTile({String title}) {
    return ListTile(
...
class CountOverview extends StatelessWidget {
  const CountOverview({
    Key key,
    @required AnimationController contentAnim2,
    @required this.slideUpTween,
    @required this.taskNotifier,
  })  : _contentAnim2 = contentAnim2,
        super(key: key);

  final AnimationController _contentAnim2;
  final Animatable<Offset> slideUpTween;
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: Column(
                children: <Widget>[
                  Builder(builder: (context) {
                    final count = taskNotifier?.inProgress?.length ?? 0;
                    final tappable = count > 0;
                    ...
                    return Expanded(
                      child: Container(
                        ...
                        child: Material(
                          ...
                          clipBehavior: Clip.antiAlias,
                          child: InkWell(
                            splashColor: AppTheme.inProgress.withOpacity(0.15),
                            highlightColor:
                  ...
                  SizedBox(height: 20),
                  Builder(builder: (context) {
                    final count = taskNotifier?.incomplete?.length ?? 0;
                    final tappable = count > 0;
                    ...
                    return Expanded(
                      child: Container(
                        ...
                        child: Material(
                          ...
                          clipBehavior: Clip.antiAlias,
                          child: InkWell(
                            splashColor: AppTheme.incomplete.withOpacity(0.15),
                            highlightColor:
